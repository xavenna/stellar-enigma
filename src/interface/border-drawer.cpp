...
void BorderDrawer::drawBorder(sf::Vector2i windowSize, sf::Vector2i panelSize, sf::Vector2i messageSize) {
  ...
  //this won't work anymore...i need to 
  for(unsigned i=border.size();i<bordLen;i++) {
    border.push_back(sf::Sprite(null));
  }
  //border.resize(bordLen);

  border[0].setTexture(corner);
  border[0].setOrigin(static_cast<sf::Vector2f>(border[0].getTexture().getSize()/2U));
  border[0].setRotation(sf::degrees(0.f));
  ...
  border[winWid+panWid+2].setRotation(sf::degrees(90));
  ...
  border[winWid*2+panWid+3].setRotation(sf::degrees(270));
  ...
  border[3*winWid+panWid+4].setRotation(sf::degrees(180));
  ...
  border[3*winWid+2*panWid+5].setRotation(sf::degrees(180));
  ...
  for(unsigned i=3*winWid+2*panWid+6;i<3*winWid+2*panWid+winHei+6;i++) {
    ...
    border[i].setRotation(sf::degrees(90));
  ...
  border[3*winWid+2*panWid+winHei+6].setRotation(sf::degrees(270));
  ...
  border[3*winWid+2*panWid+2*winHei+msgHei+7].setRotation(sf::degrees(90));
